...
export function ChangeWithdrawAmount(amount) {
  return {
...
export function withdrawAction() {
  return {
    type: ON_WITHDRAW_REQUEST,
  };
}
export function changeWithdrawCurrencyAction(withdrawCurrency,withdrawCurrencyName){
  return{
    type:CHANGE_WITHDRAW_CURRENCY,  
    withdrawCurrency,
    withdrawCurrencyName
  }
}
export function withdrawErrorAction(error) {
  return {
    type:WITHDRAW_DATA_ERROR,
    error,
  };
}
export function changePaypalAccountAction(email) {
  return {
